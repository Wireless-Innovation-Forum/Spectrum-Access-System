...
class SasImpl(sas_interface.SasInterface):
  ...
  def GetSasDumpRecord(self,request, ssl_cert=None, ssl_key=None):
    return self._SasRequest('dump', request, ssl_cert, ssl_key)

  def GetSasPPADumpRecord(self,url, ssl_cert=None, ssl_key=None):
    return self._RequestGet(url, ssl_cert, ssl_key)
