...
class PlacesQueryAutocompleteResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'predictions': ([PlaceAutocompletePrediction],),  # noqa: E501
            'status': (PlacesAutocompleteStatus,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, predictions, status, *args, **kwargs):  # noqa: E501
        """PlacesQueryAutocompleteResponse - a model defined in OpenAPI

        Args:
            predictions ([PlaceAutocompletePrediction]): Contains an array of predictions. 
    ...
    @convert_js_args_to_python_args
    def __init__(self, predictions, status, *args, **kwargs):  # noqa: E501
        """PlacesQueryAutocompleteResponse - a model defined in OpenAPI
