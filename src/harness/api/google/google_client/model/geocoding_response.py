...
class GeocodingResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'results': ([GeocodingResult],),  # noqa: E501
            'status': (GeocodingStatus,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, results, status, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            error_message (str): A short description of the error.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, results, status, *args, **kwargs):  # noqa: E501
        """GeocodingResponse - a model defined in OpenAPI
