...
class LatLngArrayString(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """LatLngArrayString - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([str]): An array of comma separated {latitude,longitude} strings..  # noqa: E501

        Keyword Args:
            value ([str]): An array of comma separated {latitude,longitude} strings..  # noqa: E501
