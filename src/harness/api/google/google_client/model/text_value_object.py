...
class TextValueObject(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, text, value, *args, **kwargs):  # noqa: E501
        """TextValueObject - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, text, value, *args, **kwargs):  # noqa: E501
        """TextValueObject - a model defined in OpenAPI
