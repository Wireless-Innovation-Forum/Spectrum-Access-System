...
class AddressComponent(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, long_name, short_name, types, *args, **kwargs):  # noqa: E501
        """AddressComponent - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, long_name, short_name, types, *args, **kwargs):  # noqa: E501
        """AddressComponent - a model defined in OpenAPI
