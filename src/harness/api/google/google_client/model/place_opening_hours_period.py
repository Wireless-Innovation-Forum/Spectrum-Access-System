...
class PlaceOpeningHoursPeriod(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'open': (PlaceOpeningHoursPeriodDetail,),  # noqa: E501
            'close': (PlaceOpeningHoursPeriodDetail,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, open, close, *args, **kwargs):  # noqa: E501
        """PlaceOpeningHoursPeriod - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, open, close, *args, **kwargs):  # noqa: E501
        """PlaceOpeningHoursPeriod - a model defined in OpenAPI
