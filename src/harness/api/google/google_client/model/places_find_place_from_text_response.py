...
class PlacesFindPlaceFromTextResponse(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, candidates, status, *args, **kwargs):  # noqa: E501
        """PlacesFindPlaceFromTextResponse - a model defined in OpenAPI
