...
class PlaceOpeningHoursPeriodDetail(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, day, time, *args, **kwargs):  # noqa: E501
        """PlaceOpeningHoursPeriodDetail - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, day, time, *args, **kwargs):  # noqa: E501
        """PlaceOpeningHoursPeriodDetail - a model defined in OpenAPI
