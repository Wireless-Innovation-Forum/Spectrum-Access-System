...
class NearestRoadsError(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, code, message, status, *args, **kwargs):  # noqa: E501
        """NearestRoadsError - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, code, message, status, *args, **kwargs):  # noqa: E501
        """NearestRoadsError - a model defined in OpenAPI
