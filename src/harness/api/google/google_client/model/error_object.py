...
class ErrorObject(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, code, message, errors, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            errors ([ErrorDetail]): A list of errors which occurred. Each error contains an identifier for the type of error and a short description.
        ...
        Keyword Args:
            ...
            status (str): A status code that indicates the error type.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, code, message, errors, *args, **kwargs):  # noqa: E501
        """ErrorObject - a model defined in OpenAPI
