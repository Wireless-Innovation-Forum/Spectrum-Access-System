...
class Fare(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, currency, value, text, *args, **kwargs):  # noqa: E501
        """Fare - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, currency, value, text, *args, **kwargs):  # noqa: E501
        """Fare - a model defined in OpenAPI
