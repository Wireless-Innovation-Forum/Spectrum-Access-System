...
class PlaceAutocompleteMatchedSubstring(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, length, offset, *args, **kwargs):  # noqa: E501
        """PlaceAutocompleteMatchedSubstring - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, length, offset, *args, **kwargs):  # noqa: E501
        """PlaceAutocompleteMatchedSubstring - a model defined in OpenAPI
