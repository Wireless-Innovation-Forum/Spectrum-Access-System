...
class GeolocationResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, location, accuracy, *args, **kwargs):  # noqa: E501
        """GeolocationResponse - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, location, accuracy, *args, **kwargs):  # noqa: E501
        """GeolocationResponse - a model defined in OpenAPI
