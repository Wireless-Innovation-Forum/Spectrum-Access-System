...
class ElevationResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'status': (ElevationStatus,),  # noqa: E501
            'results': ([ElevationResult],),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, status, results, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, status, results, *args, **kwargs):  # noqa: E501
        """ElevationResponse - a model defined in OpenAPI
