...
class DirectionsTransitVehicle(ModelNormal):
    ...
    attribute_map = {
        ...
        'type': 'type',  # noqa: E501
        'icon': 'icon',  # noqa: E501
        'local_icon': 'local_icon',  # noqa: E501
    }
    ...
    def _from_openapi_data(cls, name, type, *args, **kwargs):  # noqa: E501
        """DirectionsTransitVehicle - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            icon (str): Contains the URL for an icon associated with this vehicle type.. [optional]  # noqa: E501
            local_icon (str): Contains the URL for the icon associated with this vehicle type, based on the local transport signage.. [optional]  # noqa: E501
        """
