...
class ElevationResult(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, elevation, location, *args, **kwargs):  # noqa: E501
        """ElevationResult - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, elevation, location, *args, **kwargs):  # noqa: E501
        """ElevationResult - a model defined in OpenAPI
