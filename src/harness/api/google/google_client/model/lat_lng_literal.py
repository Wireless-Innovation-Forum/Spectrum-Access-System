...
class LatLngLiteral(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, lat, lng, *args, **kwargs):  # noqa: E501
        """LatLngLiteral - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, lat, lng, *args, **kwargs):  # noqa: E501
        """LatLngLiteral - a model defined in OpenAPI
