...
class DistanceMatrixResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'origin_addresses': ([str],),  # noqa: E501
            'destination_addresses': ([str],),  # noqa: E501
            'rows': ([DistanceMatrixRow],),  # noqa: E501
            'status': (DistanceMatrixStatus,),  # noqa: E501
        }
    ...
    attribute_map = {
        'origin_addresses': 'origin_addresses',  # noqa: E501
        'destination_addresses': 'destination_addresses',  # noqa: E501
        'rows': 'rows',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, origin_addresses, destination_addresses, rows, status, *args, **kwargs):  # noqa: E501
        """DistanceMatrixResponse - a model defined in OpenAPI
        ...
        Args:
            ...
            rows ([DistanceMatrixRow]): An array of elements, which in turn each contain a `status`, `duration`, and `distance` element.
    ...
    @convert_js_args_to_python_args
    def __init__(self, origin_addresses, destination_addresses, rows, status, *args, **kwargs):  # noqa: E501
        """DistanceMatrixResponse - a model defined in OpenAPI
