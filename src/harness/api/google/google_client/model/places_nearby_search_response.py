...
class PlacesNearbySearchResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'results': ([Place],),  # noqa: E501
            'status': (PlacesSearchStatus,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, html_attributions, results, status, *args, **kwargs):  # noqa: E501
        """PlacesNearbySearchResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            next_page_token (str): Contains a token that can be used to return up to 20 additional results. A next_page_token will not be returned if there are no additional results to display. The maximum number of results that can be returned is 60. There is a short delay between when a next_page_token is issued, and when it will become valid. . [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, html_attributions, results, status, *args, **kwargs):  # noqa: E501
        """PlacesNearbySearchResponse - a model defined in OpenAPI
