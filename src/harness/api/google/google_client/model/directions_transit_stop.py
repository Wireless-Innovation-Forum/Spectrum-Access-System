...
class DirectionsTransitStop(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, location, name, *args, **kwargs):  # noqa: E501
        """DirectionsTransitStop - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, location, name, *args, **kwargs):  # noqa: E501
        """DirectionsTransitStop - a model defined in OpenAPI
