...
class ErrorDetail(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, message, reason, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            domain (str): The domain in which the error occurred.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, message, reason, *args, **kwargs):  # noqa: E501
        """ErrorDetail - a model defined in OpenAPI
