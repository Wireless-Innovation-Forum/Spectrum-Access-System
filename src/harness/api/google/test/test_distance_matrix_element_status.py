...
class TestDistanceMatrixElementStatus(unittest.TestCase):
    """DistanceMatrixElementStatus unit test stubs"""
    ...
    def testDistanceMatrixElementStatus(self):
        """Test DistanceMatrixElementStatus"""
        # FIXME: construct object with mandatory attributes with example values
        # model = DistanceMatrixElementStatus()  # noqa: E501
        pass
