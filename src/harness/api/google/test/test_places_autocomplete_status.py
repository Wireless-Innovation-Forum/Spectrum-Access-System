...
class TestPlacesAutocompleteStatus(unittest.TestCase):
    """PlacesAutocompleteStatus unit test stubs"""
    ...
    def testPlacesAutocompleteStatus(self):
        """Test PlacesAutocompleteStatus"""
        # FIXME: construct object with mandatory attributes with example values
        # model = PlacesAutocompleteStatus()  # noqa: E501
        pass
