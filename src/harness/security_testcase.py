...
class SecurityTestCase(sas_testcase.SasTestCase):
  ...
  def create_short_lived_certificate(self, client_type, cert_name, cert_expiry_time):
    ...
    Args:
      ...
      cert_name: Certificate file name to be created. The private key shall also have
        same name.
      cert_expiry_time: Expiry time of the short lived certificate in minutes
    """
    ...
    command = "./generate_short_lived_certs.sh " + client_type + " " + cert_name + " " + str(cert_expiry_time)
