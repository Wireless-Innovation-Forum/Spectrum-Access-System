...
from dpa_calculator.number_of_aps.number_of_aps_calculator_shipborne import NUMBER_OF_UES_PER_AP_BY_REGION_TYPE
...
def get_cbsds_creator(dpa_zone: AreaCircle, is_user_equipment: bool, number_of_aps: int) -> CbsdsCreator:
    ...
    ue_per_ap = NUMBER_OF_UES_PER_AP_BY_REGION_TYPE[region_type]
