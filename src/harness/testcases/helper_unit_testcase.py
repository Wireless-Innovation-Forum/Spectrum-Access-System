...
class AssertPpaComparison(sas_testcase.SasTestCase):
   ...
   def test_shouldSucceedComparingDictsOfPpas(self):
		...
		self.assertTrue(compareDict(ppa, same_ppa_with_different_order))

		self.assertFalse(compareDict(ppa, ppa_with_one_point_different))

		self.assertFalse(compareDict(ppa, ppa_with_one_point_missing))

		self.assertFalse(compareDict(ppa, ppa_with_creator_missing))

		self.assertFalse(compareDict(ppa, ppa_with_creator_different))

		self.assertFalse(compareDict(ppa, ppa_with_pal_id_different))

		self.assertTrue(compareDict(ppa, ppa))