...
#     DEFAULT_SIMULATION_RADIUS, InterferenceParameters
...
#         context (behave.runner.Context):
#     """
#     simulation_result = AggregateInterferenceMonteCarloCalculator(interference_parameters=context,
#                                                                   number_of_iterations=number_of_iterations,
#                                                                   target_threshold=-144).simulate()
