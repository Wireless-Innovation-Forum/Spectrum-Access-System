...
Performs the extensive analysis of results obtained during a test exercising the
DPA interference check. Creates scatter and CDF plots for 3 types of analysis:
